        ...
        <div className='FAQ-Questions'>
            <div className="FAQ-Question">
                <div className={openQuestion==1&&"Active-Question"}>
                    ...
                    {openQuestion==1?<BsCaretUpFill onClick={()=>handleClick(1)} />:<BsCaretDownFill onClick={()=>handleClick(1)} />}          
                </div>
            ...
            <div className="FAQ-Question">
                <div className={openQuestion==2&&"Active-Question"}>
                    ...
                    {openQuestion==2?<BsCaretUpFill onClick={()=>handleClick(2)} />:<BsCaretDownFill onClick={()=>handleClick(2)} />}  
                    </div>            
            ...
            <div className="FAQ-Question">
                <div className={openQuestion==3&&"Active-Question"}>
                    ...
                    {openQuestion==3?<BsCaretUpFill onClick={()=>handleClick(3)} />:<BsCaretDownFill onClick={()=>handleClick(3)} />}       
                    </div>        
